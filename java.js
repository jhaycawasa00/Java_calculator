class Buttons extends React.Component{
    ...
    render(){
        return(
            <button className={this.props.buttonClass} id={this.props.buttonId} onClick={this.props.handleClick} >
...
class App extends React.Component {
    ...
    render(){
        const BtNumbers = numberList.map( (val) => <Buttons key={val.writtenForm} buttonId={val.writtenForm} handleClick={this.handleNumberClick} buttonClass="number" buttonText={val.decimalForm}/>);

        const BtOperators = operatorsList.map( (val) => <Buttons key={val.writtenOperator} buttonId={val.writtenOperator} handleClick={this.handleOperatorClick} buttonClass="operator" buttonText={val.operator} />)
        return (
            <div className="App">
                <Display historyDisplay={this.state.history} mainDisplay={this.state.mainDisplay} />
